...
def run_sota_evaluation():
    ...
    # Evaluate on subset for quick comparison (can increase for full eval)
    max_samples = min(20, len(qa_pairs))  # Evaluate on 20 samples
...
def create_sota_chat_engine():
    ...
    from main import build_index
    from src.knowledge import EmbeddingModel, FaissIndex
